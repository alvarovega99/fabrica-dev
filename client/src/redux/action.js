  ...
  return async (dispatch) => {
    try {
      var json = await axios.post(
        "http://35.190.137.182/apiusuarios/loginUser",
        payload
      );
      return dispatch({
        type: LOGIN_USER,
...
export function eliminarProductos(data) {
  return async function (dispatch) {
    const res = await axios.post(
      "http://35.190.137.182/apiproductos/delete",
      data
    );
    dispatch({
...
export function eliminarUbicacion(data) {
  return async function (dispatch) {
    const res = await axios.post(
      "http://35.190.137.182/apiubicaciones/delete",
      data
    );
    dispatch({
...
export function ingresarOperacion(data) {
    ...
    try {
      const res = await axios.post(
        "http://35.190.137.182/apioperaciones",
        data
      );
      return dispatch({
...
export function buscarCodigo(data) {
  return async function (dispatch) {
    const res = await axios.get(
      `http://35.190.137.182/apioperaciones/${data.codigoCarga}`
    );
    dispatch({
      type: GET_LOTE,
      payload: res.data,
...
export function getTotalGalleta() {
  return async function (dispatch) {
    const res = await axios.get(
      "http://35.190.137.182/apioperaciones/galleta/total"
    );
    dispatch({
...
export function getTotalPolvo() {
  return async function (dispatch) {
    const res = await axios.get(
      "http://35.190.137.182/apioperaciones/polvo/total"
    );
    dispatch({
...
export function getTotalGalletaID(id) {
  return async function (dispatch) {
    const res = await axios.get(
      `http://35.190.137.182/apioperaciones/galleta/id/${id}`
    );
    dispatch({
...
export function getTotalPolvoID(id) {
  return async function (dispatch) {
    const res = await axios.get(
      `http://35.190.137.182/apioperaciones/polvo/id/${id}`
    );
    dispatch({
...
export function postSalida(obj) {
  return async function (dispatch) {
    const res = await axios.post(
      "http://35.190.137.182/apioperaciones/status",
      obj
    );
    return dispatch({
      type: POST_SALIDA,
