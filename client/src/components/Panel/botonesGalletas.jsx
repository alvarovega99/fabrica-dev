...
import { getTotalGalletaID } from "../../redux/action";

export default function BotonesGalleta() {
    const productos = useSelector(state => state.productos);
    const totalBuscado = useSelector(state => state.totalBuscado);
    const dispatch = useDispatch();

    function buscarTotal(id) {
        dispatch(getTotalGalletaID(id))
        modal()
    }
    ...
    function modal(){
        const modal = document.getElementById('modalGalleta');     
    ...
    return (
        <div>
            <div>
                ...
                <div className={style.modal} id="modalGalleta">
